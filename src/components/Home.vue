<template>
    <div class="has-text-centered animated fadeInDown">
        <div id="reaction-role-container">
            ...
            <h2 class="subtitle">
                Clean role management using reactions!
        ...
        <div class="columns">
            <div class="column is-7 container sponsor has-text-centered">
